                ...
                <div class="filter-sidebar">
                    ...
                    <div class="filter-section">
                        <div class="filter-option">
                            <input type="checkbox" id="cover-kipas" checked>
                            <label for="cover-kipas">Tumbuhan</label>
                        </div>
                        <div class="filter-option">
                        ...
                        <div class="filter-option">
                            <input type="checkbox" id="herbal">
                            <label for="herbal">Herbal</label>
                        </div>
                        <div class="filter-option">
                            <input type="checkbox" id="hias-dinding">
                            <label for="hias-dinding">Tanaman Hias</label>
                        </div>
                        <div class="filter-option">
                            <input type="checkbox" id="hias-natal">
                            <label for="hias-natal">Tanaman Obat</label>
                        </div>
                        <div class="filter-option">
                            <input type="checkbox" id="jam-dinding">
                            <label for="jam-dinding">Benih & Bibit</label>
                        </div>
                    </div>
                ...
                <div class="main-content">
                    <div class="products-header">
                        <div class="products-count">
                            Menampilkan {{ $products->count() }} produk untuk <strong>"Tumbuhan"</strong> (1 - {{ $products->count() }} of {{ $products->count() }})
                        </div>
