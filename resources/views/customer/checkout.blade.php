...
<style>
    ...
    .checkout-mobile-main { display: none; }
    @media (max-width: 1023px) {
    ...
    .promo-badge.red { background: #b71c1c; color: #fff; }
    .promo-badge.green { background: #388e3c; color: #fff; }
    .promo-badge.plus { background: #fff; color: #388e3c; border: 1px solid #388e3c; }
...
<div class="checkout-mobile-main">
    ...
    <div class="checkout-mobile-address">
        ...
        <div class="checkout-mobile-address-info">
            ...
            <div style="font-size:0.97em;">{{ $address->recipient_name ?? '-' }} ({{ $address->recipient_phone ?? '-' }})</div>
        </div>
        <span class="checkout-mobile-address-edit" data-bs-toggle="modal" data-bs-target="#modalGantiAlamat">Ganti</span>
    </div>
    <!-- Produk -->
        ...
        <div class="checkout-mobile-product">
            <div class="checkout-mobile-product-img">
                @if($item['image'])
                    <img src="{{ asset('storage/' . $item['image']) }}" alt="{{ $item['name'] }}">
                @else
                    <div style="width:48px;height:48px;background:#333;border-radius:8px;display:flex;align-items:center;justify-content:center;color:#999;">
            ...
            <div class="checkout-mobile-product-info">
                ...
                <div class="checkout-mobile-product-price">Rp{{ number_format($item['price'],0,',','.') }} x {{ $item['quantity'] }} {{ $item['unit'] }}</div>
            </div>
        </div>
        @endforeach
