            ...
            <form id="formTambahAlamat" method="POST" action="{{ route('addresses.store') }}">
                ...
                <div class="modal-body p-0" style="border-radius:16px;overflow:hidden;">
                    ...
                    <div id="step1Alamat" class="step-alamat">
                        ...
                        <div class="px-3 pt-3 pb-3">
                            <button type="button" class="btn-green w-100" id="btnLokasiSaatIni">Gunakan Lokasi Saat
                                Ini</button>
                        </div>
                        <div class="px-3">
                        ...
                        <div class="px-3 pt-3 pb-3">
                            <button type="button" class="btn-green w-100" id="btnPilihLokasi" disabled>Pilih Lokasi
                                Ini</button>
                        </div>
                    </div>
                    ...
                    <div id="step2Alamat" class="step-alamat" style="display:none;">
                        ...
                        <div class="px-3 pb-3 d-flex gap-2">
                            <button type="button" class="btn-green w-50" id="btnAlamatBack">Kembali</button>
                            <button type="submit" class="btn-green w-50">Simpan Alamat</button>
                        </div>
                    </div>
                </div>
            </form>
...
<script>
    ...
    if (btnPilihLokasi) {
        btnPilihLokasi.onclick = function(e) {
            e.preventDefault();
            if (document.getElementById('alamatTerpilihInput').value && document.getElementById('latitudeInput')
                .value && document.getElementById('longitudeInput').value) {
