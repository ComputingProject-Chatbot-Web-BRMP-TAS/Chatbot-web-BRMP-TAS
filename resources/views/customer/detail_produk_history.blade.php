...
<div class="product-detail-modern-bg">
    <div class="product-detail-modern-container">
        ...
        <div class="product-detail-modern-center">
            ...
            <div class="product-detail-price">Rp{{ number_format($productHistory->price_per_unit, 0, ',', '.') }} / {{ $productHistory->unit }}</div>
            ...
            <div class="certificate-info">
                ...
                <div style="background: #f8f9fa; padding: 16px; border-radius: 8px; border-left: 4px solid #16a34a;">
                    ...
                    <div style="margin-bottom: 8px;">
                        <strong>Berlaku dari:</strong> {{ $productHistory->valid_from ? $productHistory->valid_from->format('d M Y') : '-' }}
                    </div>
                    <div>
                        <strong>Berlaku sampai:</strong> {{ $productHistory->valid_until ? $productHistory->valid_until->format('d M Y') : '-' }}
                    </div>
                </div>
            </div>
            @endif
            ...
            <div class="record-info" style="margin-top: 20px;">
                <div style="background: #fff3cd; border: 1px solid #ffeaa7; border-radius: 8px; padding: 12px; color: #856404;">
                    <i class="fas fa-history" style="margin-right: 6px;"></i>
                    <strong>Foto produk dari transaksi sebelumnya</strong><br>
                    <small>Direkam pada: {{ $productHistory->recorded_at ? $productHistory->recorded_at->format('d M Y H:i') : '-' }}</small>
                </div>
            </div>
        </div>
            ...
            <div class="product-detail-card">
                ...
                @if($isProductAvailable)
                    <div style="text-align: center; padding: 20px; color: #16a34a; font-weight: 500;">
                        ...
                        <div style="font-size: 0.9rem; margin-top: 4px; color: #666;">
                            Stok: {{ $currentProduct->stock - $currentProduct->minimum_stock }} {{ $currentProduct->unit }}
                        </div>
                        <a href="{{ route('produk.detail', $currentProduct->product_id) }}" 
                           class="btn-green" 
                ...
                @else
                    <div style="text-align: center; padding: 20px; color: #d32f2f; font-weight: 500;">
                        <i class="fas fa-exclamation-triangle" style="font-size: 24px; margin-bottom: 8px; color: #d32f2f;"></i>
