            ...
            <div class="col-lg-2 col-md-3">
                <div class="filter-sidebar">
                    ...
                    <div class="filter-section">
                        <div class="filter-section-title">Jenis Bunga</div>
                        <div class="filter-option">
                            <input type="checkbox" id="mawar">
                            <label for="mawar">Mawar</label>
                        </div>
                        <div class="filter-option">
                            <input type="checkbox" id="melati">
                            <label for="melati">Melati</label>
                        </div>
                        <div class="filter-option">
                            <input type="checkbox" id="anggrek">
                            <label for="anggrek">Anggrek</label>
                        </div>
                        <div class="filter-option">
                            <input type="checkbox" id="tulip">
                            <label for="tulip">Tulip</label>
                        </div>
                        <div class="filter-option">
                            <input type="checkbox" id="lily">
                            <label for="lily">Lily</label>
                        </div>
                        <div class="filter-option">
                            <input type="checkbox" id="sunflower">
                            <label for="sunflower">Bunga Matahari</label>
                        </div>
                    </div>
                ...
                <div class="main-content">
                    <div class="products-header">
                        <div class="products-count">
                            Menampilkan {{ $products->count() }} produk untuk <strong>"Bunga"</strong> (1 - {{ $products->count() }} of {{ $products->count() }})
                        </div>
