    ...
    <div style="padding-top: 80px;">
        <div class="container-fluid">
                ...
                <div class="col-12">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            ...
                            <p class="text-muted mb-0">Selamat datang, <strong>{{ auth()->user()->name }}</strong>! Anda
                                login sebagai <span class="badge bg-primary">admin</span>.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-3 mb-4">
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $stats['new_orders_today'] }}
                                    </div>
                                </div>
                                <div class="col-auto">
                ...
                <!-- Pending Orders -->
                <div class="col-lg-3 col-md-6">
                    <a href="{{ route('admin.transactions.index') }}?status=menunggu_konfirmasi_pembayaran"
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            {{ $stats['orders_need_payment_confirmation'] }}</div>
                                    </div>
                                    <div class="col-auto">
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $stats['completed_orders'] }}
                                    </div>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $stats['total_transactions'] }}
                                    </div>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $stats['total_complaints'] }}
                                    </div>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $stats['total_articles'] }}
                                    </div>
                                </div>
                                <div class="col-auto">
