                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <strong>Harga Saat Ini:</strong> Rp
                                    {{ number_format($product->price_per_unit, 0, ',', '.') }}<br>
                        ...
                        <div class="card-body">
                                            ...
                                            <div class="timeline-content">
                                                <div class="card">
                                                    <div
                                                        ...
                                                        <h6 class="mb-0">Snapshot
                                                            #{{ $product->histories->count() - $index }}</h6>
                                                        <small
                                                            class="text-muted">{{ $history->recorded_at->format('d/m/Y H:i:s') }}</small>
                                                    </div>
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <table class="table table-sm">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>{{ Str::limit($history->description, 100) }}
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><strong>Stok:</strong></td>
                                                                        <td>{{ $history->stock }} {{ $history->unit }}
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><strong>Stok Minimum:</strong></td>
                                                                        <td>{{ $history->minimum_stock }}
                                                                            {{ $history->unit }}</td>
                                                                    </tr>
                                                                </table>
                                                            </div>
                                                            <div class="col-md-6">
                                                                ...
                                                                <table class="table table-sm">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>Rp
                                                                            {{ number_format($history->price_per_unit, 0, ',', '.') }}
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><strong>Min. Pembelian:</strong></td>
                                                                        <td>{{ $history->minimum_purchase }}
                                                                            {{ $history->unit }}</td>
                                                                    </tr>
                                                                    ...
                                                                    @if ($history->valid_from)
                                                                        <tr>
                                                                            ...
                                                                            <td>{{ \Carbon\Carbon::parse($history->valid_from)->format('d/m/Y') }}
                                                                            </td>
                                                                        </tr>
                                                                    @endif
                                                                    @if ($history->valid_until)
                                                                        <tr>
                                                                            ...
                                                                            <td>{{ \Carbon\Carbon::parse($history->valid_until)->format('d/m/Y') }}
                                                                            </td>
                                                                        </tr>
                                                                    @endif
                                                                </table>
                                                        ...
                                                        @if ($history->image1 || $history->image2 || $history->image_certificate)
                                                            <div class="row mt-3">
                                                                <div class="col-12">
                                                                    ...
                                                                    <div class="row">
                                                                        @php
                                                                            $image1Path = Str::startsWith(
                                                                                $history->image1,
                                                                                'products/',
                                                                            )
                                                                                ? $history->image1
                                                                                : 'products/' . $history->image1;

                                                                            $image2Path = Str::startsWith(
                                                                                $history->image2,
                                                                                'products/',
                                                                            )
                                                                                ? $history->image2
                                                                                : 'products/' . $history->image2;

                                                                            $imageCertificatePath = Str::startsWith(
                                                                                $history->image_certificate,
                                                                                'certificates/',
                                                                            )
                                                                                ? $history->image_certificate
                                                                                : 'certificates/' .
                                                                        ...
                                                                        @if ($history->image1)
                                                                            <div class="col-md-4">
                                                                                <img src="{{ asset('storage/' . $image1Path) }}"
                                                                                    alt="Gambar Utama" class="img-thumbnail"
                                                                                    style="max-height: 100px;">
                                                                                <small class="d-block text-center">Gambar
                                                                                    Utama</small>
                                                                            </div>
                                                                        @endif
                                                                        @if ($history->image2)
                            ...
                            @else
                                <div class="text-center py-4">
                                    ...
                                    <p class="text-muted">Riwayat perubahan akan muncul setelah produk pertama kali dibuat
                                        atau diupdate.</p>
                                </div>
                            @endif
                        </div>
