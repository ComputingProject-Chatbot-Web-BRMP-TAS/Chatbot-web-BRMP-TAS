                ...
                <div class="col-12">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="stock_status" name="stock_status">
                                                ...
                                                <option value="available"
                                                    {{ request('stock_status') == 'available' ? 'selected' : '' }}>Tersedia
                                                </option>
                                                <option value="low_stock"
                                                    {{ request('stock_status') == 'low_stock' ? 'selected' : '' }}>Stok
                                                    Menipis</option>
                                                <option value="out_of_stock"
                                                    {{ request('stock_status') == 'out_of_stock' ? 'selected' : '' }}>Habis
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="has_certificate" name="has_certificate">
                                                ...
                                                <option value="yes"
                                                    {{ request('has_certificate') == 'yes' ? 'selected' : '' }}>Ada
                                                    Sertifikat</option>
                                                <option value="no"
                                                    {{ request('has_certificate') == 'no' ? 'selected' : '' }}>Tidak Ada
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="sort_by" name="sort_by">
                                                ...
                                                <option value="product_name"
                                                    {{ request('sort_by') == 'product_name' ? 'selected' : '' }}>Nama A-Z
                                                </option>
                                                <option value="price_per_unit"
                                                    {{ request('sort_by') == 'price_per_unit' ? 'selected' : '' }}>Harga
                                                </option>
                                                <option value="stock"
                                                    {{ request('sort_by') == 'stock' ? 'selected' : '' }}>Stok</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <td>
                                                    @php
                                                        ...
                                                        $validFrom = $product->valid_from
                                                            ? \Carbon\Carbon::parse($product->valid_from)
                                                            : null;
                                                        $validUntil = $product->valid_until
                                                            ? \Carbon\Carbon::parse($product->valid_until)
                                                            : null;
                                                    @endphp
                    ...
                    @if ($products->hasMorePages())
                        <div class="text-center mt-4 load-more-container">
                            <button class="btn btn-outline-primary btn-lg load-more-btn" onclick="loadMore()"
                                id="loadMoreBtn" type="button">
                            ...
                            <div class="mt-2">
                                <div class="progress" style="height: 4px; max-width: 200px; margin: 0 auto;">
                                    <div class="progress-bar" role="progressbar"
                                        ...
                                        aria-valuenow="{{ $products->count() }}" aria-valuemin="0"
