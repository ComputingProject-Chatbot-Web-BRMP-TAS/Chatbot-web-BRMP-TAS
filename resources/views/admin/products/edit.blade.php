                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" step="0.01" class="form-control @error('minimum_purchase') is-invalid @enderror" 
                                                       id="minimum_purchase" name="minimum_purchase" value="{{ old('minimum_purchase', $product->minimum_purchase) }}" required>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div>
                                                <img src="{{ asset('storage/' . $product->image1) }}" 
                                                     alt="Gambar Utama" style="max-width: 200px; height: auto;" class="img-thumbnail">
                                            </div>
                                        </div>
                                    @endif
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div>
                                                <img src="{{ asset('storage/' . $product->image2) }}" 
                                                     alt="Gambar Tambahan" style="max-width: 200px; height: auto;" class="img-thumbnail">
                                            </div>
                                        </div>
                                    @endif
                                ...
                                <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div>
                                                <img src="{{ asset('storage/' . $product->image_certificate) }}" 
                                                     alt="Gambar Sertifikat" style="max-width: 200px; height: auto;" class="img-thumbnail">
                                            </div>
                                        </div>
                                    @endif

                                    <div class="mb-3">
                                        <label for="image_certificate" class="form-label">Ganti Gambar Sertifikat</label>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('certificate_number') is-invalid @enderror" 
                                               id="certificate_number" name="certificate_number" value="{{ old('certificate_number', $product->certificate_number) }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('certificate_class') is-invalid @enderror" 
                                               id="certificate_class" name="certificate_class" value="{{ old('certificate_class', $product->certificate_class) }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="date" class="form-control @error('valid_from') is-invalid @enderror" 
                                                       id="valid_from" name="valid_from" value="{{ old('valid_from', $product->valid_from) }}">
                                                @error('valid_from')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="date" class="form-control @error('valid_until') is-invalid @enderror" 
                                                       id="valid_until" name="valid_until" value="{{ old('valid_until', $product->valid_until) }}">
                                                @error('valid_until')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
