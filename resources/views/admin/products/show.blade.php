                                    ...
                                    <div class="col-md-6">
                                        <table class="table table-borderless">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ \Carbon\Carbon::parse($product->valid_from)->format('d/m/Y') }}</td>
                                            </tr>
                                            @endif
                                            @if($product->valid_until)
                                            <tr>
                                                <td><strong>Berlaku Sampai:</strong></td>
                                                <td>{{ \Carbon\Carbon::parse($product->valid_until)->format('d/m/Y') }}</td>
                                            </tr>
                                            @endif
                                        </table>
                                    </div>
                                ...
                                @if($product->image2)
                                    <div class="mb-3">
                                        ...
                                        <img src="{{ asset('storage/' . $product->image2) }}" 
                                             alt="Gambar Tambahan" class="img-fluid rounded">
                                    </div>
                                @endif
                                ...
                                @if($product->histories->count() > 0)
                                    <div class="list-group list-group-flush">
                                        @foreach($product->histories->take(5) as $history)
                                            <div class="list-group-item d-flex justify-content-between align-items-center">
                                                <div>
                                                    <small class="text-muted">{{ $history->recorded_at->format('d/m/Y H:i') }}</small>
                                                </div>
                                    ...
                                    @if($product->histories->count() > 5)
                                        <div class="text-center mt-2">
                                            <a href="{{ route('admin.products.history', $product->product_id) }}" class="btn btn-sm btn-outline-primary">
                                                Lihat Semua History
                                            </a>
                                        </div>
                                    @endif
