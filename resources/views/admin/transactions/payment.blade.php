            ...
            <div class="row">
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h2>Detail Pembayaran
                            ke-{{ $payment->transaction->payments->where('payment_id', '<=', $payment->payment_id)->count() }}
                        </h2>
                        <a href="{{ route('admin.transactions.show', $payment->transaction->transaction_id) }}"
                                        ...
                                        <div class="col-md-6">
                                            <table class="table table-borderless">
                                                <tr>
                                                    ...
                                                    <td>{{ $payment->transaction->payments->where('payment_id', '<=', $payment->payment_id)->count() }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><strong class="text-primary">Rp
                                                            {{ number_format($payment->amount_paid, 0, ',', '.') }}</strong>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td><strong>Tanggal Pembayaran:</strong></td>
                                                    <td>{{ $payment->payment_date ? $payment->payment_date->format('d M Y H:i') : $payment->created_at->format('d M Y H:i') }}
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                        <div class="col-md-6">
                                            <table class="table table-borderless">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Rp
                                                        {{ number_format($payment->transaction->total_price, 0, ',', '.') }}
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="d-flex align-items-center mb-3">
                                                ...
                                                <div class="flex-grow-1 ms-3">
                                                    ...
                                                    <small
                                                        class="text-muted">{{ $payment->transaction->order_date->format('d M Y H:i') }}</small>
                                                </div>
                                                <div class="flex-shrink-0">
                                            ...
                                            <div class="d-flex align-items-center mb-3">
                                                <div class="flex-shrink-0">
                                                    <i class="fas fa-credit-card text-warning"
                                                        style="font-size: 1.5rem;"></i>
                                                </div>
                                                <div class="flex-grow-1 ms-3">
                                                    <h6 class="mb-0">Bukti Pembayaran Diupload</h6>
                                                    <small
                                                        class="text-muted">{{ $payment->payment_date ? $payment->payment_date->format('d M Y H:i') : $payment->created_at->format('d M Y H:i') }}</small>
                                                </div>
                                                <div class="flex-shrink-0">
                                                ...
                                                <div class="d-flex align-items-center mb-3">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        ...
                                                        <small class="text-muted">Status transaksi:
                                                            {{ $payment->transaction->order_status }}</small>
                                                    </div>
                                                    <div class="flex-shrink-0">
                                                        <i class="fas fa-check-circle text-success"></i>
                                                    </div>
                                            ...
                                            @if ($payment->payment_status == 'rejected')
                                                <div class="d-flex align-items-center mb-3">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        ...
                                                        <small class="text-muted">Customer perlu upload ulang bukti
                                                            pembayaran</small>
                                                    </div>
                                                    <div class="flex-shrink-0">
                                                        <i class="fas fa-times-circle text-danger"></i>
                                ...
                                <div class="card-body">
                                    <table class="table table-borderless">
                                        <tr>
                                            ...
                                            <td>
                                                @if ($payment->transaction->order_status == 'menunggu_kode_billing')
