...
<div class="navbar" style="display:flex;align-items:center;justify-content:space-between;">
    ...
    <div class="navbar-left" style="display:flex;align-items:center;gap:18px;min-width:320px;">
        ...
        <a href="{{ route('admin.transactions.index') }}" class="navbar-menu-link"
            style="margin-left:0px;">Transaksi</a>
        ...
        <a href="{{ route('admin.product.distribution') }}" class="navbar-menu-link" style="margin-left:0px;">Penyebaran
            Produk</a>
    </div>

    <!-- Kanan: User Section + Logout -->
    <div class="user-section"
        style="display:flex;align-items:center;gap:18px;min-width:220px;justify-content:flex-end;">
