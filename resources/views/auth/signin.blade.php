        ...
        <div class="card shadow" style="border-radius: 20px;">
            <div class="card-body p-4">
                ...
                <form method="POST" action="{{ route('login.post') }}">
                    ...
                    <button type="submit" class="btn w-100" style="background: #388e3c; color: #fff; border-radius: 10px;">Masuk</button>
                </form>
                <div class="text-center mt-3">
                    <small>Belum punya akun? <a href="{{ route('register') }}" style="color: #ffd600;">Daftar disini</a></small>
                </div>
            </div>
        </div>
    </div>
